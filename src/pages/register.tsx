...
export default function Register() {
  ...
  const formikRef = useRef<FormikProps<FormikRegisterForm>>(null);
          ...
          <>
            ...
            <Formik<FormikRegisterForm>
              ...
              validationSchema={Yup.object().shape({
                ...
                interest: Yup.string().when("new_to_fga", {
                  is: "yes",
                  then: (schema) => schema.required("Required."),
                }),
                specify_interest: Yup.string().when("new_to_fga", {
                  is: "yes",
                  then: (schema) =>
                    schema.when("interest", {
                      is: "Others",
                      then: (schema) => schema.required("Required."),
                    }),
                }),
              ...
              onSubmit={async (values, action) => {
                ...
                try {
                  ...
                  if (post.ok)
                    alert("You have succesfully activated your wristband!");
                  action.resetForm();
