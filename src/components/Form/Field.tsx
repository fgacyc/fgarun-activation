  ...
  return (
    <div className="flex w-full flex-col">
      ...
      <FormikField
        ...
        name={String(formikKey)}
        disabled={disabled}
        className={`mt-1 w-full rounded-lg bg-[#8e8e8e] px-3 py-3 font-sf outline-none disabled:text-[#fff] ${errors[formikKey] ? "!border-2 border-[#EB5757]" : "border border-[#cccccc]"}`}
      >
        {options?.map((s, i) => (
